            ...
            <div className="relative flex items-center sm:justify-center">
              ...
              <div className="relative flex items-center sm:justify-center">
                <div
                  ...
                  className="relative z-20 w-14 h-14 rounded-full bg-oklch-white-pure backdrop-blur-xl flex items-center justify-center text-oklch-white-pure text-lg font-bold shadow-lg border-2 border-oklch-primary-base transition-colors duration-300"
                >
