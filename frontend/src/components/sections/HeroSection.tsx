...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="pt-32 mb-20 lg:pt-0 mt-4 hero-bg h-dvh relative flex flex-col justify-center items-center mx-3 md:mx-8 lg:mx-16 bg-oklch-bg-primary border border-oklch-border-primary overflow-visible">
      {/* Animated Background Blobs */}
      <motion.div
        className="absolute top-10 right-10 w-32 h-32 rounded-full blur-2xl bg-oklch-secondary-lighter -z-5"
        variants={heroFloatingBlob}
        animate="animate"
      />
      <motion.div
        className="absolute top-40 right-20 w-24 h-24 rounded-full blur-xl bg-oklch-secondary-lightest -z-5"
        variants={heroFloatingBlob}
        animate="animate"
        style={{ animationDelay: '1s' }}
      />
      <motion.div
        className="absolute top-72 right-16 w-20 h-20 rounded-full blur-lg bg-oklch-purple-light -z-5"
        variants={heroFloatingBlob}
        animate="animate"
      ...
      <div className="relative z-30 w-full px-4 smd:px-8 lg:px-16 xl:px-20 parallax-text">
        <div className="max-w-7xl mx-auto ">
          <motion.div
            className="flex flex-col gap-y-20 lg:flex-row w-full justify-between items-center"
          ...
          >
            ...
            <div className="flex flex-col justify-center space-y-8 max-w-xl 2xl:max-w-3xl ">
              <motion.h1
                className="text-4xl text-pretty xs:text-5xl lg:text-6xl flex flex-wrap xl:text-7xl font-black leading-tight tracking-tight text-oklch-text-dark"
              ...
              <motion.div
                className="flex w-max flex-col sm:flex-row gap-4"
                variants={heroStaggerContainer}
                initial="hidden"
                animate="show"
              >
                <motion.div variants={heroButtonFadeIn}>
                  <Link
                    to="/services"
                    className="text-oklch-white-pure min-w-52 h-14  px-4 smd:px-8 py-4 rounded-full font-bold shadow-xl flex items-center justify-center gap-2 bg-oklch-primary-dark hover:bg-oklch-primary-darker group/btn transition-all duration-300"
                  >
                    Our Services
                    <ArrowRight size={20} className='group-hover/btn:translate-x-4 duration-300 transition-all group-hover/btn:-rotate-45 group-hover/btn:scale-110' />
                  </Link>
                </motion.div>
                <motion.div variants={heroButtonFadeIn}>
                  <Link
                    to="/contact"
                    className="bg-transparent px-4 smd:px-8 py-4 min-w-52 h-14 rounded-full font-bold flex items-center justify-center gap-2 text-oklch-primary-base border-2 border-oklch-primary-base hover:bg-oklch-secondary-light transition-all duration-300 transform hover:scale-105 group/btn"
                  >
                    Get Consultation
                    <Shield size={20} className='duration-300 transition-all group-hover/btn:animate-bounce group-hover/btn:scale-110' />
                  </Link>
                </motion.div>
              </motion.div>
              ...
              {/* Quick Stats */}
              <motion.div
                className="items-start grid grid-cols-3 gap-4 sm:gap-8 pt-6 sm:pt-8 border-t border-oklch-border-light"
                variants={heroStatsStagger}
                initial="hidden"
                animate="show"
              >
                <motion.div className="text-center" variants={heroStatItem}>
                  <AnimatedIcon
                  ...
                  />
                  <motion.div
                    className="text-lg sm:text-2xl font-bold text-oklch-text-dark"
                    variants={heroPulse}
                    animate="animate"
                  >
                    500+
                ...
                <motion.div className="text-center flex flex-col justify-center items-center" variants={heroStatItem}>
                  <AnimatedIcon
            ...
            >
              <div className="floating-cards-container flex gap-x-14 min-[850px]:gap-x-20 flex-col md:flex-row lg:flex-col gap-y-20 mb-10 relative z-10 space-y-8">
                ...
                <motion.div
                  className="z-10 floating-card-1 top-10 relative backdrop-blur-xl mx-auto xs:mx-0 rounded-3xl shadow-2xl h-max p-8 w-60 xs:w-80 group transition-all duration-500 bg-oklch-bg-light border border-oklch-white-pure cursor-pointer"
                  variants={heroCardFadeInScale}
                  whileHover={{
                    scale: 1.05,
                ...
                >
                  <div className="relative">
                    ...
                    <div className="flex xs:items-center xs:space-x-4 mb-4">
                      <div className="w-full xs:w-max">
                    ...
                    <div className="absolute -top-5 -right-5 xs:-top-2 xs:-right-2 w-8 h-8 rounded-full flex items-center justify-center shadow-lg bg-oklch-white-pure border border-oklch-primary-base">
                  ...
                  <div className="absolute -top-10 sm:-top-5 -left-5 sm:-left-20 floating-card-1">
                    <div className="text-white px-6 py-3 rounded-full text-xs xs:text-sm font-semibold shadow-xl border-2 border-white animate-bounce bg-oklch-primary-dark">
                      ✨ Trusted Partner
                    </div>
                  </div>
                  <div className="absolute -bottom-10 -right-2 sm:-bottom-8 sm:-right-20 floating-card-3">
                    <div className="text-white px-6 py-3 rounded-full text-xs xs:text-sm font-semibold shadow-xl border-2 border-white animate-pulse bg-oklch-primary-deepest">
                      🎯 Quality First
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div
                  className="floating-card-2 relative backdrop-blur-lg rounded-2xl shadow-xl p-8 w-60 xs:w-72 group transition-all duration-500 bg-oklch-bg-light-blue border border-oklch-border-primary cursor-pointer"
                  variants={heroCardFadeInScale}
                  whileHover={{
                    scale: 1.05,
                    boxShadow: '0 25px 50px rgba(0,0,0,0.1)',
                ...
                >
                  <div className="text-center space-y-4">
                    ...
                    <div className="text-xs backdrop-blur-3xl backdrop-filter font-medium rounded-full text-nowrap px-3 py-1 bg-oklch-white-pure border border-oklch-border-primary text-oklch-text-dark-alt">
                      🔥 Live metrics updating...
                    </div>
                  </div>
                  <div className="absolute -bottom-8 right-0 floating-card-2">
                    <div className="text-white px-6 py-3 rounded-full text-xs  xs:text-sm font-semibold shadow-xl border-2 border-white animate-pulse bg-oklch-primary-dark">
                      🏆 Expert Team
                    </div>
                  </div>
                </motion.div>
